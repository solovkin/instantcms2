<?php
	...
	//VALIDATION ERRORS
	define('ERR_VALIDATE_REQUIRED',          'Required field');
	define('ERR_VALIDATE_MIN',               'Number is too small');
	define('ERR_VALIDATE_MAX',               'Number is too big');
	define('ERR_VALIDATE_MIN_LENGTH',        'Value is too short');
	define('ERR_VALIDATE_MAX_LENGTH',        'Value is too long');
	...
	define('ERR_VALIDATE_UNIQUE',            'Value &laquo;%s&raquo; is already used');
	define('ERR_VALIDATE_UNIQUE_CTYPE_FIELD','System name &laquo;%s&raquo; is already used by core');
    ...
    define('LANG_MONTH2',                    'monthes');
    define('LANG_MONTH10',                   'monthes');

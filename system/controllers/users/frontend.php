...
class users extends cmsFrontend {
    ...
    public function routeAction($action_name){
        ...
        // Если после ID пользователя идет edit, значит это редактирование
        // Заменяем первый параметр на профиль
    ...
    public function logoutLockedUser($user){
        ...
        $now = time();
        $lock_until = $lock_until ? strtotime($user['lock_until']) : false;

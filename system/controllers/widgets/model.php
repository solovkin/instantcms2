...
class modelWidgets extends cmsModel {
    ...
    public function getWidgetBindingsScheme($page_id){
        ...
        foreach($binds as $bind){
            ...
            $positions[ $bind['position'] ][] = array(
                ...
                'is_disabled' => $bind['page_id'] != $page_id
            );
    ...
    public function reorderWidgetsBindings($position, $items){

        cmsCache::getInstance()->clean("widgets.bind");

        return $this->reorderByList('widgets_bind', $items, array('position'=>$position));

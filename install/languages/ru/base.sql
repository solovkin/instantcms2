...
INSERT INTO `{#}activity` (`id`, `type_id`, `user_id`, `group_id`, `subject_title`, `subject_id`, `subject_url`, `reply_url`, `date_pub`, `is_private`, `is_parent_hidden`) VALUES
(1, 8, 5, NULL, NULL, NULL, NULL, NULL, '2013-07-24 10:45:17', 0, NULL),
(2, 8, 6, NULL, NULL, NULL, NULL, NULL, '2013-07-24 10:46:33', 0, NULL),
(3, 13, 1, NULL, 'Эллиптический перигей в XXI веке', 1, '/articles/1-ellipticheskii-perigei-v-xxi-veke.html', NULL, '2013-07-24 10:49:30', 0, NULL),
(4, 13, 6, NULL, 'Почему неизменяем метеорный дождь?', 2, '/articles/2-pochemu-neizmenjaem-meteornyi-dozhd.html', NULL, '2013-07-24 11:18:46', 0, NULL),
(5, 13, 5, NULL, 'Межпланетный спектральный класс: предпосылки и развитие', 3, '/articles/3-mezhplanetnyi-spektralnyi-klass-predposylki-i-razvitie.html', NULL, '2013-07-24 11:21:06', 0, NULL),
(6, 13, 1, NULL, 'Недонасыщенный алмаз: предпосылки и развитие', 4, '/articles/4-nedonasyschennyi-almaz-predposylki-i-razvitie.html', NULL, '2013-07-24 11:22:39', 0, NULL),
(7, 13, 5, NULL, 'Почему параллельно мифопорождающее текстовое устройство', 5, '/articles/5-pochemu-parallelno-mifoporozhdayuschee-tekstovoe-ustroistvo.html', NULL, '2013-07-24 11:24:46', 0, NULL),
(8, 13, 5, NULL, 'Социометрический медиаплан: основные моменты', 6, '/articles/6-sociometricheskii-mediaplan-osnovnye-momenty.html', NULL, '2013-07-24 11:25:41', 0, NULL),
(9, 13, 6, NULL, 'Почему традиционен поток сознания?', 7, '/articles/7-pochemu-tradicionen-potok-soznanija.html', NULL, '2013-07-24 11:26:49', 0, NULL),
(10, 12, 1, NULL, 'We are all made of stars © Moby', NULL, NULL, '/users/1?wid=1&reply=1', '2013-07-24 11:35:13', 0, NULL),
(11, 10, 5, 1, 'Робототехника', 1, '/groups/1', NULL, '2013-07-24 11:48:51', 0, NULL),
(12, 10, 6, 1, 'Робототехника', 1, '/groups/1', NULL, '2013-07-24 11:49:08', 0, NULL),
(13, 14, 5, 1, 'Перспективы развития отрасли', 1, '/posts/1-perspektivy-razvitija-otrasli.html', NULL, '2013-07-24 12:00:49', 0, NULL),
(14, 15, 1, NULL, 'Новые модели роботов', 1, '/albums/1-qweqwe.html', NULL, '2013-07-24 12:44:37', 0, NULL),
(15, 15, 6, NULL, 'Красота окружающей природы', 2, '/albums/2-krasota-okruzhayuschei-prirody.html', NULL, '2013-07-24 12:57:04', 0, NULL),
(16, 7, 5, NULL, 'Василий', 6, '/users/6', NULL, '2013-07-24 13:15:02', 0, NULL),
(17, 1, 1, NULL, 'О проекте', 1, '/pages/about.html', NULL, '2013-08-08 15:07:27', 0, NULL),
(18, 1, 1, NULL, 'Правила сайта', 2, '/pages/rules.html', NULL, '2013-08-08 15:09:13', 0, NULL);
...
(15, 1, 'content', 'add.albums', 'Добавление альбомов', 'добавляет фотоальбом %s');
...
INSERT INTO `{#}comments` (`id`, `parent_id`, `level`, `ordering`, `user_id`, `date_pub`, `target_controller`, `target_subject`, `target_id`, `target_url`, `target_title`, `author_name`, `author_email`, `author_url`, `content`, `content_html`, `is_deleted`, `is_private`) VALUES
(1, 0, 1, 1, 1, '2013-07-24 11:38:20', 'content', 'articles', 6, 'articles/6-sociometricheskii-mediaplan-osnovnye-momenty.html', 'Социометрический медиаплан: основные моменты', NULL, NULL, NULL, 'В этой статье много спорных моментов.', 'В этой статье много спорных моментов.', NULL, 0),
(2, 1, 2, 2, 5, '2013-07-24 11:41:43', 'content', 'articles', 6, 'articles/6-sociometricheskii-mediaplan-osnovnye-momenty.html', 'Социометрический медиаплан: основные моменты', NULL, NULL, NULL, 'Согласен с вами, коллега.\r\nХотя и не во всём.', 'Согласен с вами, коллега.<br/>\r\nХотя и не во всём.', NULL, 0),
...
CREATE TABLE `{#}content_types` (
  ...
  `is_photo_multi` tinyint(1) DEFAULT NULL,
  ...
  KEY `is_photo_multi` (`is_photo_multi`),
...
INSERT INTO `{#}content_types` (`id`, `title`, `name`, `description`, `is_date_range`, `is_premod_add`, `is_premod_edit`, `is_cats`, `is_cats_recursive`, `is_in_groups`, `is_in_groups_only`, `is_comments`, `is_comments_tree`, `is_rating`, `is_rating_pos`, `is_tags`, `is_photo`, `is_photo_multi`, `is_auto_keys`, `is_auto_desc`, `is_auto_url`, `is_fixed_url`, `options`, `labels`) VALUES
(1, 'Страницы', 'pages', 'Статичные страницы сайта', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, '---\nlist_on: null\nprofile_on: null\nlist_show_filter: null\nitem_on: 1\n', '---\none: страница\ntwo: страницы\nmany: страниц\ncreate: страницу\n'),
(5, 'Статьи', 'articles', 'Текстовые материалы', NULL, NULL, NULL, 1, 1, NULL, NULL, 1, NULL, 1, NULL, 1, NULL, NULL, 1, 1, 1, 1, '---\nis_tags_in_list: 1\nis_tags_in_item: 1\nlist_on: 1\nprofile_on: 1\nlist_show_filter: 1\nitem_on: 1\n', '---\none: статья\ntwo: статьи\nmany: статей\ncreate: статью\n'),
(6, 'Посты', 'posts', 'Персональные публикации пользователей', NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, NULL, 1, NULL, 1, NULL, NULL, 1, 1, 1, 1, '---\nis_tags_in_list: 1\nis_tags_in_item: 1\nlist_on: 1\nprofile_on: 1\nlist_show_filter: null\nitem_on: 1\n', '---\none: пост\ntwo: поста\nmany: постов\ncreate: пост\n'),
(7, 'Фотоальбомы', 'albums', 'Альбомы с фотографиями пользователей', NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, NULL, 1, NULL, 1, NULL, NULL, 1, 1, 1, 1, '---\nis_tags_in_list: 1\nis_tags_in_item: 1\nlist_on: 1\nprofile_on: 1\nlist_show_filter: null\nitem_on: 1\n', '---\none: альбом\ntwo: альбома\nmany: альбомов\ncreate: фотоальбом\n');
...
(7, 'Лента активности', 'activity', 1, NULL, 'InstantCMS Team', 'http://www.instantcms.ru', '2.0', 0),
(8, 'Группы', 'groups', 1, '---\nis_ds_rating: 1\nis_ds_popular: 1\nis_wall: 1\n', 'InstantCMS Team', 'http://www.instantcms.ru', '2.0', 1),
...
INSERT INTO `{#}con_albums` (`id`, `title`, `content`, `slug`, `seo_keys`, `seo_desc`, `tags`, `date_pub`, `user_id`, `parent_id`, `parent_type`, `parent_title`, `parent_url`, `is_parent_hidden`, `category_id`, `is_comments_on`, `comments`, `rating`, `is_approved`, `approved_by`, `date_approved`, `is_private`, `cover_image`, `photos_count`) VALUES
(1, 'Новые модели роботов', 'Последние разработки мировой науки', '1-qweqwe', 'последние, разработки, мировой, науки', 'Последние разработки мировой науки', 'пример, роботы, фото', '2013-07-24 12:44:37', 1, 1, 'group', 'Робототехника', 'groups/1/content/albums', NULL, 1, NULL, 0, 0, 1, NULL, '2013-07-24 12:45:46', 0, '---\nbig: u1/000/79c0665e.jpg\nnormal: u1/000/30bf78dd.jpg\nsmall: u1/000/f1093774.jpg\n', 4),
(2, 'Красота окружающей природы', 'Лучшие уголки нашей планеты', '2-krasota-okruzhayuschei-prirody', 'лучшие, уголки, нашей, планеты', 'Лучшие уголки нашей планеты', 'фото, пример, природа', '2013-07-24 12:57:03', 6, NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, 0, 1, NULL, NULL, 0, '---\nbig: u6/000/1357f4a7.jpg\nnormal: u6/000/fd11e9bc.jpg\nsmall: u6/000/9daf0ddc.jpg\n', 3);
...
(1, 4, 'title', 'Название альбома', NULL, 1, NULL, 'caption', 1, 1, 1, NULL, 1, 1, 0, NULL, '---\nlabel_in_list: none\nlabel_in_item: none\nis_required: 1\nis_digits: null\nis_alphanumeric: null\nis_email: null\nis_unique: null\n', '---\n- 0\n', '---\n- 0\n'),
(2, 4, 'date_pub', 'Дата публикации', NULL, 2, NULL, 'date', 1, 1, 1, NULL, 1, 1, 1, NULL, '---\nlabel_in_list: none\nlabel_in_item: left\nshow_time: true\n', NULL, NULL),
(3, 4, 'user', 'Автор', NULL, 3, NULL, 'user', 1, 1, 0, NULL, 1, 1, 1, NULL, '---\nlabel_in_list: none\nlabel_in_item: left\n', NULL, NULL),
(4, 4, 'content', 'Описание альбома', NULL, 4, NULL, 'text', 1, 1, NULL, NULL, 1, NULL, NULL, NULL, '---\nmin_length: 0\nmax_length: 2048\nlabel_in_list: none\nlabel_in_item: none\nis_required: null\nis_digits: null\nis_alphanumeric: null\nis_email: null\nis_unique: null\n', '---\n- 0\n', '---\n- 0\n');
...
INSERT INTO `{#}con_articles` (`id`, `title`, `content`, `slug`, `seo_keys`, `seo_desc`, `tags`, `date_pub`, `user_id`, `parent_id`, `parent_type`, `parent_title`, `parent_url`, `is_parent_hidden`, `category_id`, `is_comments_on`, `comments`, `rating`, `is_approved`, `approved_by`, `date_approved`, `is_private`, `teaser`, `kind`, `notice`, `source`, `featured`) VALUES
(1, 'Эллиптический перигей в XXI веке', '<p>Как было показано выше, эклиптика отражает близкий ионный хвост – север вверху, восток слева. Прямое восхождение перечеркивает сарос, это довольно часто наблюдается у сверхновых звезд второго типа. Прямое восхождение выбирает космический космический мусор – север вверху, восток слева. Афелий неустойчив.</p>\r\n\r\n<p>Различное расположение традиционно вызывает метеорит, таким образом, часовой пробег каждой точки поверхности на экваторе равен 1666км. Млечный Путь многопланово отражает вращательный большой круг небесной сферы, данное соглашение было заключено на 2-й международной конференции "Земля из космоса - наиболее эффективные решения". В отличие от давно известных астрономам планет земной группы, ось существенно отражает вращательный тропический год, учитывая, что в одном парсеке 3,26 световых года. Бесспорно, засветка неба колеблет тропический год - это солнечное затмение предсказал ионянам Фалес Милетский. Как мы уже знаем, эффективный диаметp дает поперечник, но кольца видны только при 40–50.</p>\r\n\r\n<p>В связи с этим нужно подчеркнуть, что красноватая звездочка притягивает радиант – это скорее индикатор, чем примета. Эффективный диаметp прекрасно вызывает центральный натуральный логарифм – север вверху, восток слева. Угловая скорость вращения выбирает вращательный терминатор, Плутон не входит в эту классификацию. Поперечник отражает натуральный логарифм, но кольца видны только при 40–50.</p>', '1-ellipticheskii-perigei-v-xxi-veke', 'отражает, слева, север, восток, вверху, вращательный, только, эффективный, видны, тропический', 'Как было показано выше, эклиптика отражает близкий ионный хвост – север вверху, восток слева. Прямое восхождение перечеркивает сарос, это довольно часто наблюдается у сверхновых звезд второго типа', 'пример, статья, астрономия', '2013-07-24 10:49:30', 1, NULL, NULL, NULL, NULL, NULL, 2, NULL, 0, 0, 1, NULL, '2013-07-24 10:53:11', 0, 'Как было показано выше, эклиптика отражает близкий ионный хвост – север вверху, восток слева.', 1, NULL, 'http://referats.yandex.ru/astronomy.xml', NULL),
(2, 'Почему неизменяем метеорный дождь?', '<p>Сарос притягивает Каллисто (датировка приведена по Петавиусу, Цеху, Хайсу). Туманность Андромеды меняет далекий нулевой меридиан - это солнечное затмение предсказал ионянам Фалес Милетский. Большой круг небесной сферы, как бы это ни казалось парадоксальным, ничтожно отражает космический математический горизонт, при этом плотность Вселенной в 3 * 10 в 18-й степени раз меньше, с учетом некоторой неизвестной добавки скрытой массы. Засветка неба, несмотря на внешние воздействия, иллюстрирует межпланетный натуральный логарифм (датировка приведена по Петавиусу, Цеху, Хайсу). Метеорный дождь изменяем. Полнолуние колеблет метеорный дождь – у таких объектов рукава столь фрагментарны и обрывочны, что их уже нельзя назвать спиральными.\r\n<br/>\r\n<br/>Приливное трение существенно колеблет экватор – север вверху, восток слева. Нулевой меридиан многопланово меняет экваториальный нулевой меридиан, тем не менее, уже 4,5 млрд лет расстояние нашей планеты от Солнца практически не меняется. Хотя хpонологи не увеpены, им кажется, что рефракция вероятна. Восход , это удалось установить по характеру спектра, ничтожно ищет близкий Южный Треугольник – у таких объектов рукава столь фрагментарны и обрывочны, что их уже нельзя назвать спиральными. Большая Медведица жизненно притягивает эксцентриситет – это скорее индикатор, чем примета.&nbsp;</p>', '2-pochemu-neizmenjaem-meteornyi-dozhd', 'меридиан, нулевой, таких, колеблет, объектов, рукава, нельзя, обрывочны, фрагментарны, столь', 'Сарос притягивает Каллисто (датировка приведена по Петавиусу, Цеху, Хайсу). Туманность Андромеды меняет далекий нулевой меридиан - это солнечное затмение предсказал ионянам Фалес Милетский', 'пример, астрономия, рецензия', '2013-07-24 11:18:19', 6, NULL, NULL, NULL, NULL, NULL, 2, NULL, 0, 0, 1, NULL, '2013-07-24 11:18:46', 0, 'Ионный хвост интуитивно понятен. Соединение, несмотря на внешние воздействия, решает астероидный узел, как это случилось в 1994 году с кометой Шумейкеpов-Леви 9.', 2, 'Хорошее, глубокое исследование. Видно что автор проделал большую работу.', 'http://referats.yandex.ru/astronomy.xml', 1),
(3, 'Межпланетный спектральный класс: предпосылки и развитие', '<p>Все известные астероиды имеют прямое движение, при этом элонгация параллельна. Метеорит вызывает центральный Каллисто, хотя это явно видно на фотогpафической пластинке, полученной с помощью 1.2-метpового телескопа. Декретное время недоступно ищет восход , таким образом, атмосферы этих планет плавно переходят в жидкую мантию. Соединение последовательно.</p>\r\n\r\n<p>Эклиптика существенно меняет керн – у таких объектов рукава столь фрагментарны и обрывочны, что их уже нельзя назвать спиральными. Нулевой меридиан гасит параллакс, выслеживая яркие, броские образования. Хотя хpонологи не увеpены, им кажется, что небесная сфера прочно дает дип-скай объект, тем не менее, уже 4,5 млрд лет расстояние нашей планеты от Солнца практически не меняется. Спектральный класс перечеркивает Млечный Путь, однако большинство спутников движутся вокруг своих планет в ту же сторону, в какую вращаются планеты. Приливное трение на следующий год, когда было лунное затмение и сгорел древний храм Афины в Афинах (при эфоре Питии и афинском архонте Каллии), постоянно.</p>\r\n\r\n<p>Как мы уже знаем, реликтовый ледник отражает непреложный часовой угол – север вверху, восток слева. В отличие от давно известных астрономам планет земной группы, зенитное часовое число представляет собой экваториальный pадиотелескоп Максвелла, об этом в минувшую субботу сообщил заместитель администратора NASA. Движение представляет собой далекий параллакс – север вверху, восток слева. Ионный хвост вращает аргумент перигелия, но это не может быть причиной наблюдаемого эффекта. Летучая Рыба существенно перечеркивает далекий реликтовый ледник (расчет Тарутия затмения точен - 23 хояка 1 г. II О. = 24.06.-771). Надир, как бы это ни казалось парадоксальным, недоступно решает ионный хвост, таким образом, часовой пробег каждой точки поверхности на экваторе равен 1666км.</p>', '3-mezhplanetnyi-spektralnyi-klass-predposylki-i-razvitie', 'планет, таким, параллакс, реликтовый, недоступно, далекий, хвост, ионный, ледник, существенно', 'Все известные астероиды имеют прямое движение, при этом элонгация параллельна. Метеорит вызывает центральный Каллисто, хотя это явно видно на фотогpафической пластинке, полученной с помощью 1.2-метpового телескопа', 'пример, статья, наука', '2013-07-24 11:21:05', 5, NULL, NULL, NULL, NULL, NULL, 3, NULL, 0, 0, 1, NULL, NULL, 0, 'Все известные астероиды имеют прямое движение, при этом элонгация параллельна. Метеорит вызывает центральный Каллисто.', 2, NULL, 'http://referats.yandex.ru/astronomy.xml', NULL),
(4, 'Недонасыщенный алмаз: предпосылки и развитие', '<p>Изостазия систематически вызывает меловой орогенез, что увязывается со структурно-тектонической обстановкой, гидродинамическими условиями и литолого-минералогическим составом пород. Силл переоткладывает апофиз, поскольку непосредственно мантийные струи не наблюдаются. Исследование указанной связи должно опираться на тот факт, что ложе определяет гипергенный минерал, основными элементами которого являются обширные плосковершинные и пологоволнистые возвышенности. Пока магма остается в камере, количество пирокластического материала пластично изменяет приток, за счет чего увеличивается мощность коры под многими хребтами. Зандровое поле определяет перенос, где присутствуют моренные суглинки днепровского возраста. Пойма опускает батолит, что в общем свидетельствует о преобладании тектонических опусканий в это время.</p>\r\n\r\n<p>Руда, главным образом в карбонатных породах палеозоя, поступает в гранит, что в конце концов приведет к полному разрушению хребта под действием собственного веса. Судя по находям древнейших моренных отложений на Онежско-Ладожском перешейке, магнитное наклонение покрывает эстуарий, что обусловлено не только первичными неровностями эрозионно-тектонического рельефа поверхности кристаллических пород, но и проявлениями долее поздней блоковой тектоники. Лавовый поток смещает железистый дрейф континентов, но приводит к загрязнению окружающей среды. Капиллярное поднятие, по которому один блок опускается относительно другого, поперечно фоссилизирует гипергенный минерал, поскольку непосредственно мантийные струи не наблюдаются. В противоположность этому порода кавернозна.</p>\r\n\r\n<p>Базальтовый слой разогревает сталактит, где присутствуют моренные суглинки днепровского возраста. Межледниковье, с учетом региональных факторов, интенсивно деформирует фирн, что, однако, не уничтожило доледниковую переуглубленную гидросеть древних долин. Океаническое ложе косо аккумулирует окско-донской грабен, и в то же время устанавливается достаточно приподнятый над уровнем моря коренной цоколь. Краевая часть артезианского бассейна, так как не наследует древние поднятия, наклонно аккумулирует кремнистый ийолит-уртит, что, однако, не уничтожило доледниковую переуглубленную гидросеть древних долин.</p>', '4-nedonasyschennyi-almaz-predposylki-i-razvitie', 'струи, переуглубленную, уничтожило, гидросеть, древних, наблюдаются, аккумулирует, долин, однако, определяет', 'Изостазия систематически вызывает меловой орогенез, что увязывается со структурно-тектонической обстановкой, гидродинамическими условиями и литолого-минералогическим составом пород', 'статья, наука', '2013-07-24 11:22:39', 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, 0, 1, NULL, NULL, 0, 'Изостазия систематически вызывает меловой орогенез, что увязывается со структурно-тектонической обстановкой, гидродинамическими условиями и литолого-минералогическим составом пород.', 3, NULL, 'http://referats.yandex.ru/geology.xml', NULL),
(5, 'Почему параллельно мифопорождающее текстовое устройство', '<p>Олицетворение, согласно традиционным представлениям, выбирает диалогический лирический субъект, хотя в существование или актуальность этого он не верит, а моделирует собственную реальность. Диахрония, соприкоснувшись в чем-то со своим главным антагонистом в постструктурной поэтике, уязвима. Обсценная идиома аннигилирует парафраз, именно об этом говорил Б.В.Томашевский в своей работе 1925 года. Филиация многопланово аннигилирует экзистенциальный симулякр, таким образом в некоторых случаях образуются рефрены, кольцевые композиции, анафоры. Показательный пример – не-текст сложен.</p>\r\n\r\n<p>Пространственно-временная организация просветляет конкретный подтекст, но известны случаи прочитывания содержания приведённого отрывка иначе. Впечатление вызывает мифологический механизм сочленений, например, "Борис Годунов" А.С.Пушкина, "Кому на Руси жить хорошо" Н.А.Некрасова, "Песня о Соколе" М.Горького и др. Сумароковская школа нивелирует верлибр, при этом нельзя говорить, что это явления собственно фоники, звукописи. Графомания точно диссонирует холодный цинизм, также необходимо сказать о сочетании метода апроприации художественных стилей прошлого с авангардистскими стратегиями.</p>\r\n\r\n<p>Заимствование диссонирует механизм сочленений, потому что сюжет и фабула различаются. Мифопорождающее текстовое устройство постоянно. Эвокация последовательно дает ритмический рисунок, где автор является полновластным хозяином своих персонажей, а они - его марионетками. Контрапункт семантически отражает диалогический контекст, и это придает ему свое звучание, свой характер. Очевидно, что ямб интегрирует прозаический ритм, причём сам Тредиаковский свои стихи мыслил как “стихотворное дополнение” к книге Тальмана. Симулякр представляет собой былинный жанр, особенно подробно рассмотрены трудности, с которыми сталкивалась женщина-крестьянка в 19 веке.</p>', '5-pochemu-parallelno-mifoporozhdayuschee-tekstovoe-ustroistvo', 'диалогический, диссонирует, сочленений, механизм, аннигилирует, симулякр, не-текст, конкретный, организация, просветляет', 'Олицетворение, согласно традиционным представлениям, выбирает диалогический лирический субъект, хотя в существование или актуальность этого он не верит, а моделирует собственную реальность', 'пример, статья', '2013-07-24 11:24:45', 5, NULL, NULL, NULL, NULL, NULL, 7, NULL, 0, 1, 1, NULL, '2013-07-24 11:30:31', 0, 'Олицетворение, согласно традиционным представлениям, выбирает диалогический лирический субъект, хотя в существование или актуальность этого он не верит', 2, 'Отличная статья, как по уровню аргументации, так и по эмоциональной окраске. Рекомендуется к прочтению.', 'http://referats.yandex.ru/literature.xml', 1),
(6, 'Социометрический медиаплан: основные моменты', '<p>До недавнего времени считалось, что медийная реклама ускоряет бизнес-план, осознав маркетинг как часть производства. Еще Траут показал, что эволюция мерчандайзинга сознательно ускоряет контент, не считаясь с затратами. Стоит отметить, что рекламная поддержка одновременно тормозит ролевой conversion rate, осознавая социальную ответственность бизнеса. Ценовая стратегия усиливает креатив, используя опыт предыдущих кампаний. Стимулирование сбыта транслирует сублимированный CTR, оптимизируя бюджеты.</p>\r\n\r\n<p>Стоит отметить, что сервисная стратегия многопланово отталкивает институциональный жизненный цикл продукции, оптимизируя бюджеты. Направленный маркетинг спонтанно концентрирует презентационный материал, повышая конкуренцию. Селекция бренда усиливает коллективный показ баннера, оптимизируя бюджеты. Ребрендинг недостаточно уравновешивает стратегический выставочный стенд, используя опыт предыдущих кампаний. Тем не менее, баланс спроса и предложения нейтрализует социометрический метод изучения рынка, осознав маркетинг как часть производства. Рейт-карта порождает анализ зарубежного опыта, не считаясь с затратами.</p>', '6-sociometricheskii-mediaplan-osnovnye-momenty', 'маркетинг, оптимизируя, используя, бюджеты, стратегия, производства, отметить, затратами, считаясь, усиливает', 'До недавнего времени считалось, что медийная реклама ускоряет бизнес-план, осознав маркетинг как часть производства. Еще Траут показал, что эволюция мерчандайзинга сознательно ускоряет контент, не считаясь с затратами', 'пример, маркетинг, наука', '2013-07-24 11:25:41', 5, NULL, NULL, NULL, NULL, NULL, 9, NULL, 2, 0, 1, NULL, NULL, 0, 'Клиентский спрос, анализируя результаты рекламной кампании, упорядочивает стиль менеджмента', 3, NULL, 'http://referats.yandex.ru/marketing.xml', NULL),
(7, 'Почему традиционен поток сознания?', '<p>Эпитет разрушаем. Очевидно, что басня вероятна. Анапест, по определению просветляет культурный амфибрахий, при этом нельзя говорить, что это явления собственно фоники, звукописи. Брахикаталектический стих, за счет использования параллелизмов и повторов на разных языковых уровнях, приводит поток сознания – это уже пятая стадия понимания по М.Бахтину. Ударение, несмотря на то, что все эти характерологические черты отсылают не к единому образу нарратора, фонетически интегрирует конкретный дактиль, поэтому никого не удивляет, что в финале порок наказан. Дактиль однородно аннигилирует эпитет, но языковая игра не приводит к активно-диалогическому пониманию.\r\n<br/>\r\n<br/>Размер отражает дольник, таким образом, очевидно, что в нашем языке царит дух карнавала, пародийного отстранения. Мифопорождающее текстовое устройство отталкивает конкретный реципиент, так как в данном случае роль наблюдателя опосредована ролью рассказчика. Стиль, согласно традиционным представлениям, сложен. Драма, в первом приближении, начинает голос персонажа, несмотря на отсутствие единого пунктуационного алгоритма. Олицетворение дает диалогический жанр, например, "Борис Годунов" А.С.Пушкина, "Кому на Руси жить хорошо" Н.А.Некрасова, "Песня о Соколе" М.Горького и др.&nbsp;</p>', '7-pochemu-tradicionen-potok-soznanija', 'дактиль, несмотря, конкретный, очевидно, приводит, единому, отсылают, характерологические, черты, понимания', 'Эпитет разрушаем. Очевидно, что басня вероятна. Анапест, по определению просветляет культурный амфибрахий, при этом нельзя говорить, что это явления собственно фоники, звукописи', '0', '2013-07-24 11:26:49', 6, NULL, NULL, NULL, NULL, NULL, 8, NULL, 0, 0, 1, NULL, NULL, 0, 'Вопрос о популярности произведений того или иного автора относится к сфере культурологии, однако жанр вразнобой иллюстрирует глубокий мифопоэтический хронотоп', 1, NULL, 'http://referats.yandex.ru/literature.xml', NULL);
...
INSERT INTO `{#}con_articles_cats` (`id`, `parent_id`, `title`, `slug`, `ordering`, `ns_left`, `ns_right`, `ns_level`, `ns_differ`, `ns_ignore`) VALUES
(1, 0, '---', NULL, 1, 1, 18, 0, '', 0),
(2, 1, 'Астрономия', 'astronomija', 1, 2, 7, 1, '', 0),
(3, 2, 'Наука и космос', 'astronomija/nauka-i-kosmos', 1, 3, 4, 2, '', 0),
(4, 2, 'Астрофизика', 'astronomija/astrofizika', 2, 5, 6, 2, '', 0),
(5, 1, 'Геология', 'geologija', 2, 8, 9, 1, '', 0),
(6, 1, 'Литература', 'literatura', 3, 10, 15, 1, '', 0),
(7, 6, 'Отечественная', 'literatura/otechestvennaja', 1, 11, 12, 2, '', 0),
(8, 6, 'Зарубежная', 'literatura/zarubezhnaja', 2, 13, 14, 2, '', 0),
(9, 1, 'Маркетинг', 'marketing', 4, 16, 17, 1, '', 0);
...
(5, 5, 'teaser', 'Анонс статьи', 'Краткая аннотация к статье, будет показана в общем списке статей', 6, 'Содержание', 'text', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '---\nmin_length: 0\nmax_length: 2048\nis_html_filter: 1\nlabel_in_list: none\nlabel_in_item: none\nis_required: null\nis_digits: null\nis_alphanumeric: null\nis_email: null\nis_unique: null\n', '---\n- 0\n', '---\n- 0\n'),
...
INSERT INTO `{#}con_pages_cats` (`id`, `parent_id`, `title`, `slug`, `ordering`, `ns_left`, `ns_right`, `ns_level`, `ns_differ`, `ns_ignore`) VALUES
(1, 0, '---', NULL, 1, 1, 2, 0, '', 0);
...
INSERT INTO `{#}con_posts` (`id`, `title`, `content`, `slug`, `seo_keys`, `seo_desc`, `tags`, `date_pub`, `user_id`, `parent_id`, `parent_type`, `parent_title`, `parent_url`, `is_parent_hidden`, `category_id`, `is_comments_on`, `comments`, `rating`, `is_approved`, `approved_by`, `date_approved`, `is_private`, `picture`) VALUES
(1, 'Перспективы развития отрасли', 'Гиротахометр трансформирует гравитационный кожух, определяя инерционные характеристики системы (массы, моменты инерции входящих в механическую систему тел). Подвес позволяет исключить из рассмотрения курс, что обусловлено малыми углами карданового подвеса. Инерциальная навигация, несмотря на некоторую погрешность, заставляет перейти к более сложной системе дифференциальных уравнений, если добавить центр сил, от чего сильно зависит величина систематического ухода гироскопа. Прямолинейное равноускоренное движение основания, согласно уравнениям Лагранжа, активно. Неконсервативная сила, несмотря на некоторую погрешность, абсолютно представляет собой альтиметр, игнорируя силы вязкого трения.\r\n\r\nПараметр Родинга-Гамильтона не зависит от скорости вращения внутреннего кольца подвеса, что не кажется странным, если вспомнить о том, что мы не исключили из рассмотрения колебательный математический маятник, рассматривая уравнения движения тела в проекции на касательную к его траектории. Уравнение возмущенного движения, как следует из системы уравнений, принципиально даёт более простую систему дифференциальных уравнений, если исключить астатический период, не забывая о том, что интенсивность диссипативных сил, характеризующаяся величиной коэффициента D, должна лежать в определённых пределах. Система координат, в отличие от некоторых других случаев, заставляет иначе взглянуть на то, что такое тангаж до полного прекращения вращения. Гироинтегратор интегрирует угол курса, перейдя к исследованию устойчивости линейных гироскопических систем с искусственными силами.\r\n\r\nАвтор изображения: <a href="http://spybg.deviantart.com/">Valentin Yovchev</a>', '1-perspektivy-razvitija-otrasli', 'уравнений, погрешность, систему, несмотря, движения, исключить, подвеса, рассмотрения, некоторую, зависит', 'Гиротахометр трансформирует гравитационный кожух, определяя инерционные характеристики системы (массы, моменты инерции входящих в механическую систему тел)', 'пример, роботы', '2013-07-24 12:00:49', 5, 1, 'group', 'Робототехника', 'groups/1/content/posts', NULL, 1, NULL, 0, 0, 1, NULL, NULL, 0, '---\noriginal: u5/000/b3509a6d.jpg\nbig: u5/000/683a3c1d.jpg\nnormal: u5/000/415203a7.jpg\nsmall: u5/000/51564c4b.jpg\nmicro: u5/000/6e6ef5de.jpg\n');
...
INSERT INTO `{#}con_posts_cats` (`id`, `parent_id`, `title`, `slug`, `ordering`, `ns_left`, `ns_right`, `ns_level`, `ns_differ`, `ns_ignore`) VALUES
(1, 0, '---', NULL, 1, 1, 2, 0, '', 0);
...
(4, 6, 'content', 'Текст поста', NULL, 5, NULL, 'text', 1, 1, NULL, NULL, 1, NULL, NULL, NULL, '---\nmin_length: 0\nmax_length: 2048\nis_html_filter: 1\nlabel_in_list: none\nlabel_in_item: none\nis_required: 1\nis_digits: null\nis_alphanumeric: null\nis_email: null\nis_unique: null\n', '---\n- 0\n', '---\n- 0\n'),
...
(1, 1, '2013-07-24 11:48:28', 'Робототехника', 'Группа посвящена роботам, машиностроению и всему что с этим связано.', '---\noriginal: u1/000/18007d42.jpg\nbig: u1/000/c73173e7.jpg\nnormal: u1/000/19d6069d.jpg\nsmall: u1/000/282f4774.jpg\nmicro: u1/000/fd262e8a.jpg\n', 0, 3, 0, 0, 0, 0);
...
(2, 1, 5, 1, '2013-07-24 11:48:51'),
(3, 1, 6, 1, '2013-07-24 11:49:08');
...
(1, 1, 0, 'Статьи', '{content:articles}', 1, NULL, NULL, NULL),
(6, 1, 0, 'Фотоальбомы', 'albums', 3, '---\nclass: \n', '---\n- 0\n', NULL),
(7, 1, 0, 'Сайты', 'http://www.dmoz.org', 8, NULL, NULL, NULL),
(8, 1, 7, 'Яндекс', 'http://www.yandex.ru', 8, NULL, NULL, NULL),
(9, 1, 7, 'Google', 'http://www.google.com', 9, NULL, NULL, NULL),
(10, 1, 9, 'Google Maps', 'http://maps.google.com', 12, NULL, NULL, NULL),
(11, 1, 9, 'Google Docs', 'http://docs.google.com', 10, NULL, NULL, NULL),
(12, 1, 9, 'GMail', 'http://www.gmail.com', 11, NULL, NULL, NULL),
...
(1, 1, '2013-07-24 10:42:55', 'articles', 1, 0, 0);
...
(1, NULL, 1, '2013-07-24 12:40:35', '', '---\nbig: null\nnormal: null\nsmall: null\n', 0, 0),
(2, 1, 1, '2013-07-24 12:45:46', 'Robot by ~EgorKin', '---\nbig: u1/000/79c0665e.jpg\nnormal: u1/000/30bf78dd.jpg\nsmall: u1/000/f1093774.jpg\n', 0, 0),
(3, 1, 1, '2013-07-24 12:47:50', 'Robot headshot by ~Shalomone', '---\nbig: u1/000/3b982fd3.jpg\nnormal: u1/000/92334872.jpg\nsmall: u1/000/afe7a0b5.jpg\n', 0, 0),
(4, 1, 1, '2013-07-24 12:47:51', 'Spidy robot by ~TheRafa', '---\nbig: u1/000/6c353579.jpg\nnormal: u1/000/638ee0bb.jpg\nsmall: u1/000/576d5c6e.jpg\n', 0, 0),
(5, 1, 1, '2013-07-24 12:49:00', 'Assault Mech by ~MichalKus', '---\nbig: u1/000/91ada784.jpg\nnormal: u1/000/e9784a2e.jpg\nsmall: u1/000/126325e5.jpg\n', 0, 0),
(6, 2, 6, '2013-07-24 12:57:04', 'Nature by ~hempola', '---\nbig: u6/000/1357f4a7.jpg\nnormal: u6/000/fd11e9bc.jpg\nsmall: u6/000/9daf0ddc.jpg\n', 0, 0),
(7, 2, 6, '2013-07-24 12:57:04', 'Nature by ~lauren77', '---\nbig: u6/000/ceaf627c.jpg\nnormal: u6/000/d9b8223e.jpg\nsmall: u6/000/e33462e0.jpg\n', 0, 0),
(8, 2, 6, '2013-07-24 12:57:04', 'Nature by ~black-moon16', '---\nbig: u6/000/21e8810d.jpg\nnormal: u6/000/75119513.jpg\nsmall: u6/000/274f8465.jpg\n', 0, 0);
...
INSERT INTO `{#}rating_log` (`id`, `user_id`, `target_controller`, `target_subject`, `target_id`, `score`) VALUES
(1, 1, 'content', 'articles', 5, 1);
...
(1, 'Перевод пользователей между группами', 'users', 'migration', 1440, '2013-06-17 15:24:23', 1, 0);
...
INSERT INTO `{#}sessions_online` (`session_id`, `user_id`, `date_created`) VALUES
('3oljuu5a8051rgjauh4b1kvie3', 5, '2013-08-08 14:37:06');
...
(16, 1, 'content', 'articles', 3),
(17, 2, 'content', 'articles', 3),
(18, 9, 'content', 'articles', 3),
(19, 2, 'content', 'articles', 4),
(20, 9, 'content', 'articles', 4),
(23, 1, 'content', 'articles', 6),
(24, 15, 'content', 'articles', 6),
(25, 9, 'content', 'articles', 6),
(26, 1, 'content', 'articles', 5),
(27, 2, 'content', 'articles', 5),
(28, 1, 'content', 'articles', 2),
(29, 3, 'content', 'articles', 2),
(30, 6, 'content', 'articles', 2),
(31, 1, 'content', 'posts', 1),
(32, 23, 'content', 'posts', 1),
(39, 1, 'content', 'albums', 1),
(40, 23, 'content', 'albums', 1),
(41, 26, 'content', 'albums', 1),
(42, 26, 'content', 'albums', 2),
(43, 1, 'content', 'albums', 2),
(44, 35, 'content', 'albums', 2);
...
CREATE TABLE `{#}users` (
  ...
  `is_admin` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Администратор?',
...
INSERT INTO `{#}users` (`id`, `groups`, `email`, `password`, `password_salt`, `is_admin`, `nickname`, `date_reg`, `date_log`, `date_group`, `is_online`, `is_locked`, `lock_until`, `lock_reason`, `auth_token`, `pass_token`, `date_token`, `files_count`, `friends_count`, `time_zone`, `karma`, `rating`, `theme`, `notify_options`, `privacy_options`, `status_id`, `status_text`, `birth_date`, `city`, `hobby`, `avatar`, `icq`, `skype`, `phone`, `music`, `movies`, `site`) VALUES
(1, '---\n- 6\n', 'r2@instantsoft.ru', 'afe7a54c8181131ba43d865295bedfe7', '41153da0b5fc5eed', 1, 'Администратор', '2013-02-02 14:40:35', '2013-08-08 15:11:06', '2013-02-02 14:40:35', 0, NULL, NULL, NULL, NULL, NULL, '2013-04-24 15:01:17', 30, 0, 'Europe/Moscow', 1, 0, '---\nbg_img: null\nbg_color: ''#ffffff''\nbg_repeat: repeat\nbg_pos_x: left\nbg_pos_y: top\nmargin_top: 0\n', '---\nusers_friend_add: both\nusers_friend_delete: both\ncomments_new: both\ncomments_reply: email\nusers_friend_aссept: pm\ngroups_invite: email\nusers_wall_write: email\n', '---\nusers_profile_view: anyone\nmessages_pm: anyone\n', 1, 'We are all made of stars © Moby', '1985-10-15 00:00:00', 5106, 'Ротор векторного поля, очевидно, неоднозначен. По сути, уравнение в частных производных масштабирует нормальный лист Мёбиуса, при этом, вместо 13 можно взять любую другую константу.', NULL, '987654321', 'admin', '100-20-30', 'Disco House, Minimal techno', 'разные интересные', 'instantcms.ru'),
(5, '---\n- 4\n', 'fedor@example.com', 'f6ec31851e2d6fbbf0f23b3cc6cf304c', '46530e5240da6482', 0, 'Федор', '2013-07-24 10:45:17', '2013-08-08 14:32:09', '2013-07-24 10:45:17', 0, NULL, NULL, NULL, NULL, NULL, '2013-07-24 10:45:17', 15, 1, 'Europe/Moscow', 0, 1, '---\n', '---\n', '---\n', NULL, NULL, '1990-09-22 00:00:00', 4400, 'Молодой и перспективный демо-пользователь.\r\nМой аватар нарисовал ~ftw302', '---\noriginal: u5/000/aad0672c.png\nbig: u5/000/bf1138f8.png\nnormal: u5/000/5d41e295.png\nsmall: u5/000/39f7f7f2.png\nmicro: u5/000/2bf63de5.png\n', '012345678', 'нету', 'сотовый', 'Разная электроника', 'Сериалы про студентов', NULL),
(6, '---\n- 4\n', 'vasya@example.com', 'eedce6b8445a514a8e7b66c4b239bc67', '07c4a3d599d1b057', 0, 'Василий', '2013-07-24 10:46:33', '2013-08-08 15:10:59', '2013-07-24 10:46:33', 0, NULL, NULL, NULL, NULL, NULL, '2013-07-24 13:13:35', 17, 1, 'Asia/Yekaterinburg', 1, 0, '---\n', '---\n', '---\n', NULL, NULL, '1981-02-12 00:00:00', 5106, 'Профессионал по части профессионализма.\r\nМой аватар нарисовал ~Cardinal-Len', '---\noriginal: u6/000/ebae233d.png\nbig: u6/000/df1ac7a8.png\nnormal: u6/000/93c5cf60.png\nsmall: u6/000/c040492e.png\nmicro: u6/000/78f83728.png\n', '876543210', 'echo123', '100-10-10', 'классические сонаты', 'английские детективы', 'http://www.yandex.ru');
...
INSERT INTO `{#}users_fields` (`id`, `ctype_id`, `name`, `title`, `hint`, `ordering`, `fieldset`, `type`, `is_in_list`, `is_in_item`, `is_in_filter`, `is_private`, `is_fixed`, `is_system`, `values`, `options`, `groups_read`, `groups_edit`) VALUES
(1, NULL, 'birth_date', 'Возраст', NULL, 4, 'Анкета', 'age', NULL, NULL, 1, NULL, NULL, NULL, NULL, '---\ndate_title: Дата рождения\nshow_y: 1\nshow_m: \nshow_d: \nshow_h: \nshow_i: \nrange: YEAR\nlabel_in_item: left\nis_required: \nis_digits: \nis_alphanumeric: \nis_email: \nis_unique: \n', '---\n- 0\n', '---\n- 0\n'),
(2, NULL, 'city', 'Город', 'Укажите город, в котором вы живете', 3, 'Анкета', 'city', NULL, NULL, 1, NULL, 1, 1, NULL, '---\nlabel_in_item: left\nis_required: 1\nis_digits: \nis_alphanumeric: \nis_email: \nis_unique: \n', '---\n- 0\n', '---\n- 0\n'),
(3, NULL, 'hobby', 'Расскажите о себе', 'Расскажите о ваших интересах и увлечениях', 11, 'О себе', 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '---\nmin_length: 0\nmax_length: 255\nlabel_in_item: none\nis_required: \nis_digits: \nis_alphanumeric: \nis_email: \nis_unique: \n', '---\n- 0\n', '---\n- 0\n'),
(5, NULL, 'nickname', 'Никнейм', 'Ваше имя для отображения на сайте', 1, 'Анкета', 'string', NULL, NULL, 1, NULL, 1, 1, NULL, '---\r\nlabel_in_list: left\r\nlabel_in_item: left\r\nis_required: 1\r\nis_digits: \r\nis_number: \r\nis_alphanumeric: \r\nis_email: \r\nis_unique: \r\nmin_length: 2\r\nmax_length: 64\r\n', '---\n- 0\n', '---\n- 0\n'),
(6, NULL, 'avatar', 'Аватар', 'Ваша основная фотография', 2, 'Анкета', 'image', NULL, NULL, NULL, NULL, 1, 1, 'normal | default/avatar.jpg\r\nsmall | default/avatar_small.jpg\r\nmicro | default/avatar_micro.png', '---\nsize_teaser: micro\nsize_full: normal\nsizes:\n  - micro\n  - small\n  - normal\nlabel_in_item: left\nis_required: null\nis_digits: null\nis_alphanumeric: null\nis_email: null\n', '---\n- 0\n', '---\n- 0\n'),
(7, NULL, 'icq', 'ICQ', NULL, 8, 'Контакты', 'string', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '---\nmin_length: 0\nmax_length: 9\nlabel_in_item: left\nis_required: \nis_digits: 1\nis_alphanumeric: \nis_email: \nis_unique: \n', '---\n- 0\n', '---\n- 0\n'),
(8, NULL, 'skype', 'Skype', NULL, 9, 'Контакты', 'string', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '---\nmin_length: 0\nmax_length: 32\nlabel_in_item: left\nis_required: \nis_digits: \nis_alphanumeric: \nis_email: \nis_unique: \n', '---\n- 0\n', '---\n- 0\n'),
(9, NULL, 'phone', 'Телефон', NULL, 7, 'Контакты', 'string', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '---\nmin_length: 0\nmax_length: 255\nlabel_in_item: left\nis_required: \nis_digits: \nis_alphanumeric: \nis_email: \nis_unique: \n', '---\n- 0\n', '---\n- 0\n'),
(10, NULL, 'music', 'Любимая музыка', NULL, 6, 'Предпочтения', 'string', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '---\nmin_length: 0\nmax_length: 255\nlabel_in_item: left\nis_required: null\nis_digits: null\nis_alphanumeric: null\nis_email: null\n', '---\n- 0\n', '---\n- 0\n'),
(11, NULL, 'movies', 'Любимые фильмы', NULL, 5, 'Предпочтения', 'string', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '---\nmin_length: 0\nmax_length: 255\nlabel_in_item: left\nis_required: null\nis_digits: null\nis_alphanumeric: null\nis_email: null\n', '---\n- 0\n', '---\n- 0\n'),
(12, NULL, 'site', 'Сайт', 'Ваш персональный веб-сайт', 10, 'Контакты', 'url', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '---\nredirect: 1\nauto_http: 1\nlabel_in_item: left\nis_required: null\nis_digits: null\nis_alphanumeric: null\nis_email: null\nis_unique: null\n', '---\n- 0\n', '---\n- 0\n');
...
INSERT INTO `{#}users_friends` (`id`, `user_id`, `friend_id`, `is_mutual`) VALUES
(1, 6, 5, 1),
(2, 5, 6, 1);
...
INSERT INTO `{#}users_karma` (`id`, `user_id`, `profile_id`, `date_pub`, `points`, `comment`) VALUES
(1, 5, 6, '2013-07-24 13:15:30', 1, 'Мой друг заслужил этот плюс!'),
(2, 6, 1, '2013-07-24 13:16:13', 1, 'Уважение и почет от лица всех демо-пользователей');
...
(1, 'Лента', 'activity', 'activity', 1, 2),
(2, 'Контент', 'content', 'content', 1, 3),
(3, 'Друзья', 'users', 'friends', 1, 1),
(4, 'Комментарии', 'comments', 'comments', 1, 4),
(5, 'Группы', 'groups', 'groups', 1, 5),
(6, 'Репутация', 'users', 'karma', 1, 6);
...
(4, 3, 'Меню пользователя', NULL, NULL, NULL, NULL, NULL, '---\n- 0\n', '---\n- 1\n', '---\nmenu: personal\nis_detect: 1\nmax_items: 0\n', 0, 'right-center', 2),
(5, 3, 'Меню действий', NULL, NULL, NULL, NULL, NULL, '---\n- 0\n', NULL, '---\nmenu: toolbar\nis_detect: null\nmax_items: 0\n', 0, 'right-center', 3),
(6, 8, 'Онлайн', NULL, NULL, 1, NULL, NULL, '---\n- 0\n', NULL, '---\nis_avatars: null\ngroups: null\n', 1, 'right-bottom', 1),
(7, 1, 'Добро пожаловать!', 'Регистрация | auth/register\r\nВход | auth/login', NULL, 1, NULL, NULL, '---\n- 1\n', NULL, '---\ncontent: |\n  Мы рады приветствовать Вас на нашем сайте!\r\n  Пожалуйста, зарегистрируйтесь, чтобы получить доступ ко всем возможностям.\n', 1, 'left-top', 1),
(8, 10, 'Облако тегов', NULL, NULL, 1, NULL, NULL, '---\n- 0\n', NULL, '---\nordering: tag\nstyle: cloud\nmax_fs: 22\nmin_fs: 12\nlimit: 10\n', 1, 'right-bottom', 3),
(9, 6, 'Лента активности', 'Вся | activity\r\n{Моих друзей | activity/index/friends}\r\n{Моя | activity/index/my}', NULL, 1, NULL, NULL, '---\n- 0\n', NULL, '---\ndataset: all\nshow_avatars: 1\ndate_group: null\nlimit: 5\n', 1, 'left-top', 2),
(10, 4, 'Новые статьи', 'Все статьи | articles\r\n{Добавить статью | articles/add}', NULL, 1, NULL, NULL, '---\n- 0\n', NULL, '---\nctype_id: 5\ndataset:\nimage_field:\nlimit: 5\n', 1, 'left-top', 3),
(11, 7, 'Новые комментарии', 'Все | comments\r\n{Моих друзей | comments/index/friends}\r\n{Мои | comments/index/my}', NULL, 1, NULL, NULL, '---\n- 0\n', NULL, '---\nshow_avatars: 1\nshow_text: 1\nlimit: 10\n', 1, 'left-top', 5),
(12, 5, 'Категории', NULL, NULL, 1, NULL, NULL, '---\n- 0\n', NULL, '---\nctype_name: 0\nis_root: null\n', 147, 'right-bottom', 1),
(13, 4, 'Новые фотоальбомы', 'Все альбомы | albums\r\nДобавить альбом | albums/add', NULL, 1, NULL, 1, '---\n- 0\n', NULL, '---\nctype_id: 7\ndataset:\nimage_field: cover_image\nlimit: 5\n', 1, 'left-top', 4),
(14, 2, 'Новые', 'Все | users', NULL, 1, NULL, 1, '---\n- 0\n', NULL, '---\ndataset: latest\nis_avatars: 1\ngroups: null\nlimit: 10\n', 1, 'right-bottom', 2),
...
(107, 'content', 'pages.all', 'LANG_WP_CONTENT_ALL_PAGES', 'Страницы', NULL, 'pages\r\npages-*\r\npages/*', NULL),
(108, 'content', 'pages.list', 'LANG_WP_CONTENT_LIST', 'Страницы', NULL, 'pages\r\npages-*\r\npages/*', 'pages/*.html\r\npages/add\r\npages/edit/*'),
(109, 'content', 'pages.item', 'LANG_WP_CONTENT_ITEM', 'Страницы', NULL, 'pages/*.html', NULL),
(110, 'content', 'pages.edit', 'LANG_WP_CONTENT_ITEM_EDIT', 'Страницы', NULL, 'pages/add\npages/edit/*', NULL),
...
(150, 'content', 'articles.edit', 'LANG_WP_CONTENT_ITEM_EDIT', 'Статьи', NULL, 'articles/add\narticles/edit/*', NULL),
(151, 'content', 'posts.all', 'LANG_WP_CONTENT_ALL_PAGES', 'Посты', NULL, 'posts\nposts-*\nposts/*', NULL),
(152, 'content', 'posts.list', 'LANG_WP_CONTENT_LIST', 'Посты', NULL, 'posts\nposts-*\nposts/*', 'posts/*.html\nposts/add\nposts/edit/*'),
(153, 'content', 'posts.item', 'LANG_WP_CONTENT_ITEM', 'Посты', NULL, 'posts/*.html', NULL),
(154, 'content', 'posts.edit', 'LANG_WP_CONTENT_ITEM_EDIT', 'Посты', NULL, 'posts/add\nposts/edit/*', NULL),

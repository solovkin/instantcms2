<?php
    ...
    define('LANG_BETA_WARNING',             'This is a beta distributed only for testing purposes');
    ...
    define('LANG_PATHS_ROOT_INFO',          'All paths are relative to: <br/><b>%s</b>');
    ...
    define('LANG_ADMIN_INFO',               "Please enter administrator's e-mail and password");
    ...
    define('LANG_CFG_METAKEYS',             'site keywords');

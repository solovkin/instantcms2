                ...
                <fieldset>
                    ...
                    <ul class="flat">
                        <?php if (isset($manifest['author']['name'])) { ?>
                            <li>
                                <?php html($manifest['author']['name']); ?>
                            </li>
                        <?php } ?>
                        <?php if (isset($manifest['author']['email'])) { ?>
                            <li>
                                <a href="mailto:<?php echo $manifest['author']['email']; ?>"><?php html($manifest['author']['email']); ?></a>
                            </li>
                        <?php } ?>
                        <?php if (isset($manifest['author']['url'])) { ?>
                            <li>
                                <a href="<?php echo $manifest['author']['url']; ?>" target="_blank"><?php html($manifest['author']['url']); ?></a>
                            </li>
                        <?php } ?>
                    </ul>
